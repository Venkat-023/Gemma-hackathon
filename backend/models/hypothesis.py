...
class Hypothesis(Base):
    ...
    supporting_paper_ids: Mapped[list[int]] = mapped_column(JSONB, default=list)
    supporting_evidence: Mapped[list[dict]] = mapped_column(JSONB, default=list)
    suggested_experiments: Mapped[list[str]] = mapped_column(JSONB, default=list)
    research_gaps_addressed: Mapped[list[str]] = mapped_column(JSONB, default=list)
    cross_domain_insights: Mapped[list[str]] = mapped_column(JSONB, default=list)
